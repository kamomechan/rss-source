...
//hww
router.get('/hww/news', lazyloadRouteHandler('./routes/hww/news'));

//gematsu
router.get('/gematsu/vn-news', lazyloadRouteHandler('./routes/gematsu/vn-news'));

//keyfc
router.get('/keyfc/index', lazyloadRouteHandler('./routes/keyfc/index'));

//vndb
//router.get('/vndb/just-released', lazyloadRouteHandler('./routes/vndb/just-released'));
router.get('/vndb/official', lazyloadRouteHandler('./routes/vndb/official'));
router.get('/vndb/offi-jp', lazyloadRouteHandler('./routes/vndb/offi-jp'));
router.get('/vndb/uo-ch', lazyloadRouteHandler('./routes/vndb/uo-ch'));
router.get('/vndb/uo-en', lazyloadRouteHandler('./routes/vndb/uo-en'));
